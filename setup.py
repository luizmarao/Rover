...
setup(
    ...
    install_requires=[
        ...
        'numpy',
        'matplotlib',
        'stable-baselines3-contrib @ git+https://github.com/Stable-Baselines-Team/stable-baselines3-contrib.git@a7a4e540a6e8c7178c8b647ae2f753d869edd77d#egg=sb3_contrib',
